/*Description: Client script utilisé pour le calcul du rapport pourccentage Steria. Il est appelé par le scheduled job '(ASP) Reports Calc'
*********************************************
Scheduled job '(ASP) Reports Calc':
Run: Daily
Time: 07:55:00
Run this script:
var reportCalc = new ReportsCalcUtil();
reportCalc.insert_in_table();
*********************************************
